...
public class CurrentOrderActivity extends AppCompatActivity{
    ...
    private void fetchInfo() {
        ...
        db.collection(USER_LIST).document(resUid).get().addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()){
                ...
                resPhoneNum = (String) documentSnapshot.get("phonenumber");
                resName = (String) documentSnapshot.get("name");
                tvAddress.setText((String)documentSnapshot.get("address"));
